...
export async function POST(req) {
  try {
    ...
    const { status, startDate, description, currency, projectManager } = body;
    ...
    const result = await executeQuery(
      ...
      INSERT INTO projects_manual
        (project_id, status, customer_id, start_date, description, created_on, currency, project_manager)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
      `,
      [
        newProjectId,
