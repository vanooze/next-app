...
*/
    ...
    const savedFiles = [];
    const dirPath = path.join(process.cwd(), "public", "uploads", "marketing");
    ...
    const file = savedFiles.length ? savedFiles.join(", ") : null;
    ...
    const [insertResult] = await connection.query(
      ...
      (client_name, proj_desc, date_received, personnel, status, date, created_by, file)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
      `,
      [
        clientName,
