...
import { RepairTableWrapper } from "./table/table";
import { useUserContext } from "@/components/layout/UserContext";
import { RepairTasks } from "@/helpers/db";
import { AddTask } from "./operation/add-tasks";
import { SearchIcon } from "@/components/icons/searchicon";
import { EyeIcon } from "@/components/icons/table/eye-icon";

export const TMIGTasks = () => {
  ...
  const {
    ...
    error,
    isLoading,
  } = useSWR<RepairTasks[]>("/api/department/TMIG/tasks", fetcher, {
  ...
  return (
    <div className="my-10 px-4 lg:px-6 max-w-[95rem] mx-auto w-full flex flex-col gap-4">
      ...
      <h3 className="text-xl font-semibold">All Repair Tasks</h3>
