...
export default function PrePorjectAgreement({ project }: SOWProps) {
    ...
    const fetchassignedPersonnel = async () => {
      ...
      try {
        const res = await fetch(
          `/api/department/PMO/project_tasks/documentation/sow/personnel/get?projectId=${projectId}`
        );
        const data = await res.json();
  ...
  const submitForm = async () => {
    ...
    try {
      for (const file of files) {
        ...
        const res = await fetch(
          "/api/department/PMO/project_tasks/documentation/sow/create",
          {
            method: "POST",
            body: formData,
          }
          ...
          onSelectionChange={async (keys) => {
            ...
            if (typeof selected === "string") {
              ...
              if (projectId) {
                try {
                  await fetch(
                    "/api/department/PMO/project_tasks/documentation/sow/personnel",
                    {
                      method: "POST",
