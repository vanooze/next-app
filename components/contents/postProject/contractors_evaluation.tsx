...
import { CONTRACTORS_EVAL_CAN_UPLOAD_DESIGNATION } from "@/helpers/restriction";
...
export default function ContractorEvaluation({
  ...
  const key = projectId
    ? `/api/department/PMO/project_tasks/postProject/contractor_evaluation?id=${projectId}`
    : null;
    ...
    try {
      for (const file of files) {
        ...
        const res = await fetch(
          "/api/department/PMO/project_tasks/postProject/contractor_evaluation/create",
          {
            method: "POST",
            body: formData,
          },
  ...
  const canUpload =
    user?.designation &&
    CONTRACTORS_EVAL_CAN_UPLOAD_DESIGNATION.some((role) =>
