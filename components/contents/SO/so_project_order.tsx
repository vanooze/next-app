...
import { PROJECT_ORDER_CAN_UPLOAD_DESIGNATION } from "@/helpers/restriction";
...
export default function SOProjectOrder({ project }: SOProjectOrderProps) {
    ...
    try {
      for (const file of files) {
        ...
        const res = await fetch(
          "/api/department/PMO/project_tasks/so/po/create",
          {
            method: "POST",
            body: formData,
          },
  ...
  const canUpload =
    user?.designation &&
    PROJECT_ORDER_CAN_UPLOAD_DESIGNATION.some((role) =>
