...
export const TMIG_TASKS_ACCESS_DESIGNATION = ["TMIG"];
...
export const CHART_KICK_OFF_CAN_UPLOAD_DESIGNATION = ["PMO", "TECHNICAL ADMIN"];
...
export const AWARDING_DOCU_CAN_UPLOAD_DESIGNATION = ["PMO", "TECHNICAL ADMIN"];
...
export const POST_PROJ_REVIEW_CAN_UPLOAD_DESIGNATION = ["TECHNICAL ADMIN"];
